...
void testPairing() {
    ...
    // but the function hasn't finished yet.
    {
        ...
        const std::vector<int> vec2 {8,5,9,7};
        ...
        PairingPQ<int> pairing4 { vec2.cbegin(), vec2.cend() };
        pairing4.updateElt(pairing4.getLeftMostChild(),15);
        assert(pairing4.top() == 15);
